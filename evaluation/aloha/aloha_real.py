...
class PiperRealEnv:
    ...
    def __init__(self, init_node, *, reset_pos:Optional[List[float]] = None, setup_robots: bool = False):
        ...
        self.ros_operator = ros_oper.RosOperator(ros_config)
    ...
    def get_observation(self):
        ...
        while True and not rospy.is_shutdown():
            ...
            (img_front, img_left, img_right, img_front_depth, img_left_depth, img_right_depth,
             puppet_arm_left, puppet_arm_right, puppet_eef_left, puppet_eef_right, robot_base) = result
    ...
    def step(self, action, STOP=False):
        ...
        for act in interp_actions:
            ...
            if  not ros_config["disable_puppet_arm"]:
                if ros_config["use_eef"]:
                    self.ros_operator.puppet_arm_publish_eef(left_action, right_action)
                else:
